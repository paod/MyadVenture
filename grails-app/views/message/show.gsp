	...
	<body>
		...
		<div id="show-message" class="content scaffold-show" role="main">
			...
			<ol class="property-list message">
				...
				<g:if test="${messageInstance?.thread}">
				<li class="fieldcontain">
					<span id="thread-label" class="property-label"><g:message code="message.thread.label" default="Thread" /></span>
					
						<span class="property-value" aria-labelledby="thread-label"><g:fieldValue bean="${messageInstance}" field="thread"/></span>
